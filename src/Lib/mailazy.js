...
const fn = async (email, lastName, name, token) => {
    ...
    try {
        const resp = await client.send({
            ...
            Hola ${name} ${lastName} por favor ingresa al siguiente link para restablecer tu contraseña frontend-arquitech-i2tx815l5-deveckor.vercel.app/restartPassword?token=${token}`,
        });
